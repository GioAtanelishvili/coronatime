<section class="grid w-full mt-6 md:mt-10 fixed md:static left-0 text-sm text-left border border-neutral-100 md:rounded-lg overflow-hidden">
    <div class="bg-neutral-100 grid w-full grid-cols-4 md:grid-cols-table items-center">
        <x-dashboard.stats-header column="location">Location</x-dashboard.stats-header>
        <x-dashboard.stats-header column="confirmed">New cases</x-dashboard.stats-header>
        <x-dashboard.stats-header column="deaths">Deaths</x-dashboard.stats-header>
        <x-dashboard.stats-header column="recovered">Recovered</x-dashboard.stats-header>
    </div>
